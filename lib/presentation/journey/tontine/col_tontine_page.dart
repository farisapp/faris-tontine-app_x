...
import 'col_add_tontine_page.dart';
import 'col_tontine_details_page.dart';

class ColTontinePage extends StatefulWidget {
  const ColTontinePage({Key? key}) : super(key: key);

  @override
  _ColTontinePageState createState() => _ColTontinePageState();
}

class _ColTontinePageState extends State<ColTontinePage> {
  ...
  final List<BottomNavigationBarItem> _bottomBarItems = const [
    BottomNavigationBarItem(
      ...
      label: "Listes des épargnes",
    ),
    BottomNavigationBarItem(
      icon: Icon(Icons.group_add, size: 40),
      label: "Participer à une épargne collective",
    ),
    BottomNavigationBarItem(
    ...
    return GetBuilder<TontineController>(
      builder: (tontineController) {
        ...
        final tontinesCollectives = tontineController.tontines!
            .where((tontine) =>
        tontine.type != null &&
            tontine.type!.toUpperCase().contains("COLLECTIVE") &&
            ...
            Expanded(
              child: tontinesCollectives.isEmpty
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Aucune épargne collective trouvée. Cliquez sur le bouton <Créer une épargne collective> pour commencer.\n"
